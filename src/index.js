// falloffice SDK · sovereign single-file library · MIT · AI-Native Solutions
// Extracted from falloffice/index.html · 78582 bytes of source logic
...
(function (root) {
  ...
  (function () {
    function go() { if (typeof FallKit !== 'undefined') FallKit.init({ seedName: "falloffice-push" }); }
    else go();
  })();
'use strict';
// ════════════════════════════════════════════════════════════════
